...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        comboBox.setBackground(new Color(252, 228, 76));
        ...
        comboBox2.setBackground(new Color(252, 228, 76));
        ...
        comboBox3.setBackground(new Color(252, 228, 76));
        ...
        comboBox4.setBackground(new Color(252, 228, 76));
        comboBox4.setFont(new Font("Raleway", Font.BOLD, 14));
        comboBox4.setBounds(350, 270, 320, 30);
        add(comboBox4);

        //Occupation
        JLabel l7 = new JLabel("Occuptaion :");
        ...
        comboBox5.setBackground(new Color(252, 228, 76));
